...
$linkstr=$this->mkUrl($this->actyear,$this->actmonth,$var);
	...
	if ($this->isEvent($var)){
		if ($this->eventUrl){
			$out="<td class=\"".$this->eventID."\"><a id='polo' href=\"".$this->eventUrl."\">".$var."</a>".$eventContent."</td>";
			$this->eventUrl=false;
		}
...
$out="";
	if ($this->weekUrl){
		...
		$out.="<a id='cal' href=\"".$this->weekUrl.$glue.$this->yearID."=".$year."&amp;".$this->weekID."=".$week."\">".$week."</a>";
	}
