...
<nav id="menu_header">
  ...
  <body>
    ...
    <h1 id="lol">Nouveau mot de passe</h1>
    <i>Veuillez saisir votre adresse mail pour recevoir </br>un nouveau mot de passe.</i></br></br>
    <label for="adressemail1">Adresse mail : </label><input id="adressemail2" type="text" /></br></br>
