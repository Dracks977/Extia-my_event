...
<nav id='menu_header'>
  <ul id='head'>
    ...
    <li class='h'><a href='page/event_pro.php' class='info'><img alt='Extia1' src='img/pro.png' id='pro' style='width:50px'><span class='mdr'>Pro</span></a></li>
    <li class='h'><a href='page/event_fun.php' class='info'><img alt='Extia1' src='img/fun.png' id='fun' style='width:50px'><span class='je'>Fun</span></a></li>
